...
class Bottle2neck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1,downsample=None,  scales=4, groups=1, sim=True,  norm_layer=True):
        ...
        self.relu = nn.ReLU(inplace=True)
        #SE模块
        self.sim = SimAM(planes * self.expansion) if sim else None
